...
public class CookieController {
    ...
    @GetMapping("/")
    public ConnectedResponse fortune() {
        return getResponse();
    }

    private ConnectedResponse getResponse() {

        return getFortune();
    }

    private ConnectedResponse getFortune() {
        return new ConnectedResponse(decision.getResponse().getService(),
                activity.getResponse().getService(),
